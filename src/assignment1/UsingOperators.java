...
public class UsingOperators {
	...
	public static void main(String[] args) {
		/*
		 * unary operator-The Java unary operators require only one operand. Unary
		 * operators are used to perform various operations i.e.:
		 * incrementing/decrementing a value by one, negating an expression, inverting
		...
		System.out.println(Integer.toBinaryString(~v));
		// Java Arithmetic Operators-Java arithmetic operators are used to perform
